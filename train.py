if __name__ == '__main__':
    ...
    from summarize_utils import summarize_data
    from utils import *
    ...
    print(f"[INFO] Training a model with parameters:\n"
    ...
    print(f"[INFO] Summarize data...")
    reviews = summarize_data(reviews, 'description_cleaned', 'summary')

    print("f[INFO] Training Doc2Vec model...")
